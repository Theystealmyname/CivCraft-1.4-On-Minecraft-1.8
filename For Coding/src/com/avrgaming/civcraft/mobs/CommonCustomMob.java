...
import com.moblib.mob.ISpawnable;
...
public abstract class CommonCustomMob implements ICustomMob {
	...
	public void setAttack(double attack) {
		entity.getAttributeInstance(GenericAttributes.c).setValue(attack);
	}
	
	public void setMovementSpeed(double speed) {
		entity.getAttributeInstance(GenericAttributes.c).setValue(speed);
	}
	
	public void setFollowRange(double range) {
		entity.getAttributeInstance(GenericAttributes.c).setValue(range);
	}
	
	public double getFollowRange() {
		double value;
		try {
			value = entity.getAttributeInstance(GenericAttributes.c).getValue();
	...
	public void modifySpeed(double percent) {
		double speed = entity.getAttributeInstance(GenericAttributes.c).getValue();
		speed *= percent;
